...
def load_ppo_wrapper(env_kind):
    ...
    if env_kind == "classic":
        from rl.ludo_rl.envs.model import EnvConfig
        from rl.ludo_rl.ppo_strategy import PPOStrategy
    else:  # single-seat
        from rl.ludo_rls.envs.model import EnvConfig
        from rl.ludo_rls.ppo_strategy import PPOStrategy
