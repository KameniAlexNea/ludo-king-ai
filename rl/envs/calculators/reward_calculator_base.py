...
from .probabilistic_calculator_base import ProbabilisticCalculator
...
class RewardCalculator:
    ...
    def compute_comprehensive_reward(
        ...
        if extra_turn:
            ...
            component_rewards["extra_turn"] = extra_turn_reward
        ...
        if abs(progress_delta) > 1e-9:
            ...
            component_rewards["progress"] = progress_reward

        # Time penalty (very small, just to encourage efficiency)
        component_rewards["time"] = rcfg.time_penalty
        ...
        component_rewards["inactivity"] = inactivity_penalty
        ...
        component_rewards["active"] = active_bonus
