...
class TestHybridProbStrategyBehavior(unittest.TestCase):
    ...
    def test_prefers_capture_advanced_token(self):
        cap = {"token_id": 0, "move_type": "normal", "current_position": 5, "target_position": 8, "captures_opponent": True, "captured_tokens": [{"token_id": 1, "player_color": "blue", "finished_steps": 150}], "is_safe_move": False, "strategic_value": 10}
        progress = {"token_id": 1, "move_type": "normal", "current_position": 10, "target_position": 13, "captures_opponent": False, "captured_tokens": [], "is_safe_move": True, "strategic_value": 25}
        ctx = {
            ...
            "players": [
                ...
                {"color": "blue", "finished_tokens": 0, "tokens": [{"token_id": 1, "position": 8}]},
            ],
        }
