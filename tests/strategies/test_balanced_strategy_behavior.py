...
class TestBalancedStrategyBehavior(unittest.TestCase):
    ...
    def test_capture_when_behind(self):
        capture_move = {"token_id": 0, "move_type": "normal", "current_position": 5, "target_position": 8, "captures_opponent": True, "captured_tokens": [{"token_id": 1, "player_color": "green"}], "is_safe_move": False, "strategic_value": 10}
        safe_move = {"token_id": 1, "move_type": "normal", "current_position": 10, "target_position": 12, "captures_opponent": False, "captured_tokens": [], "is_safe_move": True, "strategic_value": 20}
        ctx = {
            ...
            "players": [
                {"color": "red", "finished_tokens": 0, "tokens": [{"token_id": 0, "position": 5}, {"token_id": 1, "position": 10}]},
                {"color": "green", "finished_tokens": 2, "tokens": [{"token_id": 1, "position": 8}]},
            ],
        }
    ...
    def test_safe_when_ahead(self):
        ...
        risky_capture = {"token_id": 0, "move_type": "normal", "current_position": 5, "target_position": 8, "captures_opponent": True, "captured_tokens": [{"token_id": 1, "player_color": "green"}], "is_safe_move": False, "strategic_value": 25}
        safe_move = {"token_id": 1, "move_type": "normal", "current_position": 10, "target_position": 12, "captures_opponent": False, "captured_tokens": [], "is_safe_move": True, "strategic_value": 20}
        ctx = {
            ...
            "current_situation": {"player_color": "red"},
            "players": [
                {"color": "red", "finished_tokens": 3, "tokens": [{"token_id": 0, "position": 5}, {"token_id": 1, "position": 10}]},
                ...
                {"color": "green", "finished_tokens": 1, "tokens": [
