...
class TestSimpleBaselineEvalCallback(unittest.TestCase):
    ...
    def test_run_eval(self, mock_get_action_mask, mock_build_triplets):
        ...
        mock_base_env.step.return_value = (
            ...
            {
                "finished_tokens": 4,
                "captured_opponents": 2,
                "captured_by_opponents": 1,
                "episode_capture_ops_available": 5,
                "episode_capture_ops_taken": 3,
                "episode_finish_ops_available": 4,
                "episode_finish_ops_taken": 2,
                "episode_home_exit_ops_available": 3,
                "episode_home_exit_ops_taken": 1,
            },
        )
