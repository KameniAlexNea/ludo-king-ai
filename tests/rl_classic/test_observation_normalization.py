...
import unittest
import numpy as np
from ludo_rl.ppo_strategy import PPOStrategy, EnvConfig
...
class TestObservationNormalization(unittest.TestCase):
    ...
    def test_obs_normalization_bounds(self):
        ...
        for d in dice_values:
            ...
            turn_count = ctx['current_situation']['turn_count'] if 'current_situation' in ctx else ctx['game_info']['turn_count']
