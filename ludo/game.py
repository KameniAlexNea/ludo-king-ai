...
class LudoGame:
    ...
    def play_turn(self, token_id: Optional[int] = None) -> Dict:
        ...
        # Execute the move
        move_result = self.execute_move(current_player, selected_move['token_id'], dice_value)
    ...
    def get_game_state_for_ai(self) -> Dict:
        ...
        return {
            ...
            'valid_moves': self.get_valid_moves(self.get_current_player(), self.last_dice_value) if self.last_dice_value > 0 else []
        }
    ...
    def get_ai_decision_context(self, dice_value: int) -> Dict:
        ...
        context = {
            ...
            'opponents': [
                ...
                for p in self.players if p != current_player
            ],
            'valid_moves': valid_moves,
            'strategic_analysis': self._analyze_strategic_situation(current_player, valid_moves)
        }
    ...
    def _analyze_strategic_situation(self, player: Player, valid_moves: List[Dict]) -> Dict:
        ...
        analysis = {
            ...
            'best_strategic_move': max(valid_moves, key=lambda m: m['strategic_value']) if valid_moves else None
        }
