"""Stable-Baselines3 training script for Ludo (Single-Seat Self-Play).

Usage (after installing requirements):
    python training/train_single_seat.py --total-steps 2000000 --n-envs 8
...
from rl.ludo_rls.callbacks.tournament_callback import SelfPlayTournamentCallback
from rl.ludo_rls.envs.ludo_env import EnvConfig, LudoGymEnv
